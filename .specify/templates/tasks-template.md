...
- [ ] T004 Define layer boundaries and module ownership (UI, service, engine abstraction, document adapter, storage/config)
- [ ] T005 [P] Establish common anonymization engine interface contracts
...
- [ ] T012 Add deterministic pseudonym/mapping test fixtures and reproducibility checks
- [ ] T013 Add graceful-degradation paths for missing models and optional services
...
- [ ] T016 [P] [US1] Deterministic output regression test in tests/integration/test_[name]_determinism.py
...
- [ ] TXXX Verify no layer-boundary bypasses were introduced
- [ ] TXXX Verify new engines/adapters can be added without core interface changes
